...
public class AdminAddMedicine extends AppCompatActivity implements View.OnClickListener {
    ...
    private void addMedicine(){
        ...
        class AddMedicine extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(AdminAddMedicine.this,"Adding...","Wait...",false,false);
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(AdminAddMedicine.this,s,Toast.LENGTH_LONG).show();
            }
